...
export function ProjectsView() {
  ...
  function upsertLocal(project: Project) {
    setProjects((prev) => {
      const list = prev ?? [];
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <NewProjectDialog onCreated={upsertLocal} />
      </div>
      ...
      <ProjectDetailSheet project={selected} open={sheetOpen} onOpenChange={setSheetOpen} onChanged={upsertLocal} />
    </div>
  );
}
